...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body
        className="flex min-h-screen flex-col overflow-x-hidden bg-background text-foreground antialiased selection:bg-selection selection:text-selection-foreground"
        suppressHydrationWarning
      >
        <noscript>
