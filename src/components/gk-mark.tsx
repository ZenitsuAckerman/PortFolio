  ...
  return (
    ...
    >
      ...
      <text x="150" y="144" textAnchor="middle">
        <tspan className="gk-mark-base">R</tspan>
        <tspan className="gk-mark-highlight">S</tspan>
      </text>
    </svg>
  );
}
...
export function getMarkSVG() {
  // "RS" brand mark - updated design with opacity effects
  return `<svg width="300" height="200" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
    <style>
     ...
     <text x="150" y="144" text-anchor="middle">
       <tspan class="gk-mark-base">R</tspan>
       <tspan class="gk-mark-highlight">S</tspan>
     </text>
  </svg>`;
}
