    ...
    <section className="flex flex-col gap-3 py-2 sm:flex-row">
      ...
      <div className="flex flex-1 flex-col justify-center gap-3 p-1 sm:p-2">
        ...
        <div className="max-w-3xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
          <p>
            I build practical, AI-driven systems with{" "}
            <TechPill
              name="Python"
              iconKey="python"
            ...
            />
            . 2nd Year CSE Student at Saveetha Engineering College & AI Intern at Re-Tech Solutions building practical solutions with{" "}
            <TechPill
              name="Express"
              iconKey="express"
              className="text-foreground"
